...
class AtlasRCA(BaseRCA):
    def __init__(self, **args):
        ...
        itk.MultiThreaderBase.SetGlobalDefaultThreader(1)
        print("Threader in use:", itk.MultiThreaderBase.GetGlobalDefaultThreader())
        print(f"ITK will use {itk.MultiThreaderBase.GetGlobalDefaultNumberOfThreads()} threads.")
