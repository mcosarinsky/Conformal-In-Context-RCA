...
class UniverSeg(BaseSegmentationEvaluator):
    ...
    def predict(self, d_reference):
        ...
        return candidate_scores # return all scores for metrics
...
class SAM2(BaseSegmentationEvaluator):
    ...
    def predict(self, d_reference):
        ...
        for sample in d_reference:
            ...
            save_images(all_images, temp_img_dir='temp_img_dir') # Save images to temp_img_dir
            inference_state = self.predictor.init_state(video_path='temp_img_dir')
